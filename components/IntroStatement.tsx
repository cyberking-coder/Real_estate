...
export function IntroStatement() {
  ...
  return (
    <section id="about" className="bg-charcoal py-section">
      <div ref={ref} className="container-luxe">
        <p className="eyebrow mb-12 text-center">— A Culture of Excellence</p>
...
function Word({
  ...
  const emphasised = /excellence|experiences|living/i.test(children);
  return (
